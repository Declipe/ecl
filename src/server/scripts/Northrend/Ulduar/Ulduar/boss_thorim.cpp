    ...
    public:
        ...
        struct boss_thorimAI : public BossAI
        {
            ...
            void FinishEncounter()
            {
                ...
                if (_hardMode)
					me->SummonGameObject(RAID_MODE(GO_CACHE_OF_STORMS_HARDMODE_10, GO_CACHE_OF_STORMS_HARDMODE_25), 2134.948f, -286.436f, 419.5051f, 1.588249f, G3D::Quat(0.f, 0.f, 0.7132502f, 0.7009096f), 604800);
                else
					me->SummonGameObject(RAID_MODE(GO_CACHE_OF_STORMS_10, GO_CACHE_OF_STORMS_25), 2134.948f, -286.436f, 419.5051f, 1.588249f, G3D::Quat(0.f, 0.f, 0.7132502f, 0.7009096f), 604800);
